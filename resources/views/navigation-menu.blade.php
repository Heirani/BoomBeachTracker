<nav x-data="{ open: false }" class="fixed top-0 left-0 right-0 bg-white border-b border-gray-100 shadow-md shadow-gray-200 z-300">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        <span class="font-bold text-indigo-600">{{ __('BOOM BEACH TRACKER') }}</span>
                    </x-nav-link>
                </div>
            </div>
